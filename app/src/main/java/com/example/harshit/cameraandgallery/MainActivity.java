...
public class MainActivity extends AppCompatActivity {
    ...
    private void onSelectFromGalleryResult(Intent data) {
        ...
        Intent in1 = new Intent(this, OcrActivity.class);
        in1.putExtra("byteArray",byteArray);
    ...
    private void onCaptureImageResult(Intent data) {
     ...
     //   photoName=System.currentTimeMillis();
        ...
        i.putExtra("byteArray", bytes.toByteArray());
        startActivity(i);
    }
    ...
    {
        Intent ocr = new Intent(MainActivity.this, OcrActivity.class);
        startActivity(ocr);
    }
